...
```console
$ sudo fluent-cap-ctl --add-cap dac_read_search [-f /path/to/bin/ruby]
...
```console
$ sudo fluent-cap-ctl --add-cap dac_override [-f /path/to/bin/ruby]
...
```console
$ sudo fluent-cap-ctl --add-cap "dac_override,cap_dac_read_search" -f $(rbenv prefix)/bin/ruby
Updating dac_read_search,dac_override done.
Adding dac_read_search,dac_override done.
$ fluent-cap-ctl --get-cap -f $(rbenv prefix)/bin/ruby
...
Updating dac_read_search done.
Adding dac_read_search done.
$ fluent-cap-ctl --get-cap [-f /path/to/bin/ruby]
